...
public class UserHome extends AppCompatActivity {
    ...
    DBHandler db = new DBHandler(UserHome.this, null, null, 1);
    ...
    TextView user_home_post, user_home_like, user_home_comment, user_home_like_count, user_home_comment_count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_home_post = (TextView) findViewById(R.id.user_home_post);
        user_home_like = (TextView) findViewById(R.id.user_home_like);
        user_home_comment = (TextView) findViewById(R.id.user_home_comment);
        user_home_like_count = (TextView) findViewById(R.id.user_home_like_count);
        user_home_comment_count = (TextView) findViewById(R.id.user_home_comment_count);
        ...
        dialog = new ProgressDialog(UserHome.this);
        ...
        user_home_like.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (post.isLike()) {
                    ...
                    user_home_like.setTextColor(getResources().getColor(R.color.white));
                    ...
                    // this block states that user has already pressed like before, so now do dislike
                    user_home_like.setTextColor(getResources().getColor(R.color.red));
    ...
    public String userHomeWS(String url) {
        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                Toast.makeText(UserHome.this, "Failed to Connect to Server", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    if (status) {
                        ...
                        user_home_post.setText(post.getPost());
                        user_home_like_count.setText("" + post.getUpVote());
                        ...
                        Toast.makeText(UserHome.this, "Unable to Load Data", Toast.LENGTH_SHORT).show();
                        return;
                    }
