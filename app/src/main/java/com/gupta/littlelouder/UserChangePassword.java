...
public class UserChangePassword extends AppCompatActivity {
    ...
    DBHandler db = new DBHandler(UserChangePassword.this, null, null, 1);
    ...
    EditText user_change_password_old_paasowrd, user_change_password_new_paasowrd1, user_change_password_new_paasowrd2;
    Button user_change_password_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_change_password_button = (Button) findViewById(R.id.user_change_password_button);
        user_change_password_old_paasowrd = (EditText) findViewById(R.id.user_change_password_old_paasowrd);
        user_change_password_new_paasowrd1 = (EditText) findViewById(R.id.user_change_password_new_paasowrd1);
        user_change_password_new_paasowrd2 = (EditText) findViewById(R.id.user_change_password_new_paasowrd2);
        ...
        dialog = new ProgressDialog(UserChangePassword.this);
        ...
        user_change_password_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                dialog.show();

                oldPass = user_change_password_old_paasowrd.getText().toString();

                if (oldPass.equals(user.getPassword())) {

                    newPass1 = user_change_password_new_paasowrd1.getText().toString();
                    newPass2 = user_change_password_new_paasowrd2.getText().toString();

                    URL = URL1 + "?userid="+user.getUserId()+"&password="+newPass1;

                    new UserChangePasswordDown().execute(URL);
                    ...
                    user_change_password_old_paasowrd.setText("");
                    user_change_password_new_paasowrd1.setText("");
                    user_change_password_new_paasowrd2.setText("");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent nextActivity = new Intent(this, UserHome.class);
            nextActivity.putExtras(userBundle);
            startActivity(nextActivity);
        }
        else if (id == R.id.change_password) {
            Intent nextActivity = new Intent(this, UserChangePassword.class);
            nextActivity.putExtras(userBundle);
            startActivity(nextActivity);
        }
    ...
    public String userChangePasswordWS(String url) {
        ...
        try {
            ...
            if (statusCode == 200) {
                ...
                Toast.makeText(UserChangePassword.this, "Failed to Connect to Server", Toast.LENGTH_SHORT).show();
    ...
    class UserChangePasswordDown extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            return userChangePasswordWS(URL); //***************************************************************************
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    if (status) {
                        ...
                        Toast.makeText(UserChangePassword.this, "Password Didn't Changed", Toast.LENGTH_SHORT).show();
                        return;
                    }
